...
//import com.ass.service.DepartServiceImpl;
//import com.ass.service.StaffsService;
//import com.ass.service.StaffsServiceImpl;
import com.ass.service.*;
...
@ComponentScan("com.ass")
@EnableSpringDataWebSupport
@EnableJpaRepositories("com.ass.responsitory")
public class ApplicationConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emBean.setPackagesToScan(new String[]{"com.ass.model"});
    ...
    //cấu hình chạy departs
    @Bean
    public DepartService departService()
    {
        return new DepartServiceImpl();
    }
    //  cấu hình bean chạy Staffs
    @Bean
    public StaffsService staffsService()
    {
        return new StaffsServiceImpl();
    }
    @Bean
